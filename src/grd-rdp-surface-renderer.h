...
void grd_rdp_surface_renderer_inhibit_rendering (GrdRdpSurfaceRenderer *surface_renderer);

void grd_rdp_surface_renderer_uninhibit_rendering (GrdRdpSurfaceRenderer *surface_renderer);
