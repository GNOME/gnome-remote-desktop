...
typedef struct _GrdRemoteClient
{
  ...
  GrdDBusRemoteDesktopHandover *handover_interface;
                          ...
                          GrdRemoteClient              *remote_client)
{
  ...
  grd_dbus_remote_desktop_handover_complete_start_handover (interface,
                                                            invocation,
                                                            certificate,
                                                            key);
                   ...
                   GrdSession      *session)
{
  ...
  remote_client->handover_interface =
    grd_dbus_remote_desktop_handover_skeleton_new ();
