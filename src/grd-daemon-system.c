...
{
  GrdDBusRemoteDesktopHandover *interface;
...
static gboolean
on_handle_take_client (GrdDBusRemoteDesktopHandover *interface,
                       ...
                       GrdRemoteClient              *remote_client)
{
  ...
  grd_dbus_remote_desktop_handover_complete_take_client (interface,
                                                         invocation,
                                                         fd_list,
                                                         fd_variant);
...
static gboolean
on_handle_start_handover (GrdDBusRemoteDesktopHandover *interface,
                          GDBusMethodInvocation        *invocation,
                          ...
                          GrdRemoteClient              *remote_client)
{
  ...
  const char *certificate = grd_settings_get_rdp_server_cert (settings);
  const char *key = grd_settings_get_rdp_server_key (settings);
  ...
  grd_dbus_remote_desktop_handover_complete_start_handover (
                    ...
                    GrdRemoteClient *remote_client)
{
  ...
  handover->interface = grd_dbus_remote_desktop_handover_skeleton_new ();
                                   ...
                                   GrdDaemonSystem   *daemon_system)
{
  ...
  grd_dbus_remote_desktop_handover_emit_take_client_ready (
    remote_client->handover_dst->interface);
}
